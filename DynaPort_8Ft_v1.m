function varargout = DynaPort_8Ft_v1(varargin)
% DYNAPORT_8FT_V1 MATLAB code for DynaPort_8Ft_v1.fig
%      DYNAPORT_8FT_V1, by itself, creates a new DYNAPORT_8FT_V1 or raises the existing
%      singleton*.
%
%      H = DYNAPORT_8FT_V1 returns the handle to a new DYNAPORT_8FT_V1 or the handle to
%      the existing singleton*.
%
%      DYNAPORT_8FT_V1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DYNAPORT_8FT_V1.M with the given input arguments.
%
%      DYNAPORT_8FT_V1('Property','Value',...) creates a new DYNAPORT_8FT_V1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DynaPort_8Ft_v1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DynaPort_8Ft_v1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DynaPort_8Ft_v1

% Last Modified by GUIDE v2.5 31-Jan-2019 12:57:04

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @DynaPort_8Ft_v1_OpeningFcn, ...
                   'gui_OutputFcn',  @DynaPort_8Ft_v1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DynaPort_8Ft_v1 is made visible.
function DynaPort_8Ft_v1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DynaPort_8Ft_v1 (see VARARGIN)

% Choose default command line output for DynaPort_8Ft_v1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes DynaPort_8Ft_v1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = DynaPort_8Ft_v1_OutputFcn(hObject, eventdata, handles) 
