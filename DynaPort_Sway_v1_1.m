function varargout = DynaPort_Sway_v1_1(varargin)
% DYNAPORT_SWAY_V1_1 MATLAB code for DynaPort_Sway_v1_1.fig
%      DYNAPORT_SWAY_V1_1, by itself, creates a new DYNAPORT_SWAY_V1_1 or raises the existing
%      singleton*.
%
%      H = DYNAPORT_SWAY_V1_1 returns the handle to a new DYNAPORT_SWAY_V1_1 or the handle to
%      the existing singleton*.
%
%      DYNAPORT_SWAY_V1_1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DYNAPORT_SWAY_V1_1.M with the given input arguments.
%
%      DYNAPORT_SWAY_V1_1('Property','Value',...) creates a new DYNAPORT_SWAY_V1_1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DynaPort_Sway_v1_1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DynaPort_Sway_v1_1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DynaPort_Sway_v1_1

% Last Modified by GUIDE v2.5 31-Jan-2019 11:49:28

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @DynaPort_Sway_v1_1_OpeningFcn, ...
                   'gui_OutputFcn',  @DynaPort_Sway_v1_1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DynaPort_Sway_v1_1 is made visible.
function DynaPort_Sway_v1_1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DynaPort_Sway_v1_1 (see VARARGIN)

% Choose default command line output for DynaPort_Sway_v1_1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes DynaPort_Sway_v1_1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = DynaPort_Sway_v1_1_OutputFcn(hObject, eventdata, handles) 
...
if length(get(handles.id, 'String')) ~= 3
    ...
    newdir = [prev_path{1} '/Sway_analysis'];
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[infilename, inpathname] = uigetfile('*EC.txt;*EO.txt', 'Multiselect', 'on');
prev_str = get(handles.file_list, 'String');
