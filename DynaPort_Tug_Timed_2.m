...
%      singleton*.
%
%      H = DYNAPORT_TUG_TIMED_2 returns the handle to a new DYNAPORT_TUG_TIMED_2 or the handle to
%      the existing singleton*.
%
%      DYNAPORT_TUG_TIMED_2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DYNAPORT_TUG_TIMED_2.M with the given input arguments.
%
%      DYNAPORT_TUG_TIMED_2('Property','Value',...) creates a new DYNAPORT_TUG_TIMED_2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DynaPort_Tug_Timed_2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DynaPort_Tug_Timed_2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DynaPort_Tug_Timed_2

% Last Modified by GUIDE v2.5 12-Jul-2019 08:23:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @DynaPort_Tug_Timed_2_OpeningFcn, ...
                   'gui_OutputFcn',  @DynaPort_Tug_Timed_2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DynaPort_Tug_Timed_2 is made visible.
function DynaPort_Tug_Timed_2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DynaPort_Tug_Timed_2 (see VARARGIN)

% Choose default command line output for DynaPort_Tug_Timed_2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes DynaPort_Tug_Timed_2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = DynaPort_Tug_Timed_2_OutputFcn(hObject, eventdata, handles) 
