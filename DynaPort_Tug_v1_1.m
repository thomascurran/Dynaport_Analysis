function varargout = DynaPort_Tug_v1_1(varargin)
% DYNAPORT_TUG_V1_1 MATLAB code for DynaPort_Tug_v1_1.fig
%      DYNAPORT_TUG_V1_1, by itself, creates a new DYNAPORT_TUG_V1_1 or raises the existing
%      singleton*.
%
%      H = DYNAPORT_TUG_V1_1 returns the handle to a new DYNAPORT_TUG_V1_1 or the handle to
%      the existing singleton*.
%
%      DYNAPORT_TUG_V1_1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DYNAPORT_TUG_V1_1.M with the given input arguments.
%
%      DYNAPORT_TUG_V1_1('Property','Value',...) creates a new DYNAPORT_TUG_V1_1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DynaPort_Tug_v1_1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DynaPort_Tug_v1_1_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @DynaPort_Tug_v1_1_OpeningFcn, ...
                   'gui_OutputFcn',  @DynaPort_Tug_v1_1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DynaPort_Tug_v1_1 is made visible.
function DynaPort_Tug_v1_1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DynaPort_Tug_v1_1 (see VARARGIN)

% Choose default command line output for DynaPort_Tug_v1_1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes DynaPort_Tug_v1_1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = DynaPort_Tug_v1_1_OutputFcn(hObject, eventdata, handles) 
